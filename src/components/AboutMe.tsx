    ...
    <section id="about" className="w-screen font-roboto min-h-screen flex flex-col items-center justify-center">
      ...
      >
        ...
        <div className={`flex flex-col items-center`}>
          ...
          <span className={`font-mono font-bold text-xs dark:text-sky-200 text-sky-900`}>
            Get to know me
          </span>
        </div>
        {/* DESCRIPTION */}
        <div className="flex flex-col gap-4 mt-8 text-lg text-center">
          <span>
            ...
            specializing in <Code>React</Code> and <Code>.NET Core</Code>. With
            a strong background in both frontend and backend technologies, I
            excel at creating dynamic, responsive, high-performance
            applications.
          </span>
          <span>
            ...
            skills to freelance projects and help turn your innovative ideas
            into reality. Let’s work together to create something amazing!
          </span>
        </div>
